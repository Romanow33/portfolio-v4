...
export default function HeaderCard() {
    ...
    return (
        <Stack component={'section'} justifyContent={'center'} alignItems={'center'} minHeight={'100vh'}>
            <Stack direction={{ md: 'row', xs: 'column' }} justifyContent={'flex-start'} alignItems={'center'} columnGap={{ md: 12, sm: 5 }} rowGap={4}>
                <Image src={img} height={350} width={350} style={{ borderRadius: "100%", backgroundColor: '#fff' }} alt='Personal Image' />
                <Stack rowGap={2}>
                    ...
                    <Typography variant="button" fontWeight={300} width={'100%'} textAlign={'center'} fontSize={{ md: 20, lg: 20, xs: 14 }}>
                        Software developer | Custom development
                    </Typography>
                </Stack>
            </Stack>
